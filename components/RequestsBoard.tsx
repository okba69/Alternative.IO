...
export function RequestsBoard() {
  ...
  return <>
    ...
    <div className="request-layout">
      ...
      <aside className="request-side"><SessionPanel /><p className="request-side-note">Une request est une demande publique. Les autres membres peuvent la commenter et proposer une solution.</p></aside>
    </div>
