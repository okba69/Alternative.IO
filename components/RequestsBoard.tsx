...
export function RequestsBoard() {
  ...
  return <>
    ...
    <div className="request-layout">
      ...
      <aside className="request-side"><p className="request-side-note">Tu pilotes le catalogue ? Valide les nouvelles requests depuis l’espace admin.</p><Link className="button button-light request-action" href="/admin">Ouvrir l’admin <span>↗</span></Link></aside>
    </div>
